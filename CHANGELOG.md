...
- Bump `bytes` from 1.11.0 to 1.11.1 ([#993](https://github.com/vbrandl/hoc/pull/993))
- Bump `git2` from 0.20.3 to 0.20.4 ([#993](https://github.com/vbrandl/hoc/pull/993))
- Bump `hyper-util` from 0.1.19 to 0.1.20 ([#993](https://github.com/vbrandl/hoc/pull/993))
